...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { email: @aluno.email, nome: @aluno.nome, prontuario: @aluno.prontuario, turma: @aluno.turma }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { email: @aluno.email, nome: @aluno.nome, prontuario: @aluno.prontuario, turma: @aluno.turma }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
